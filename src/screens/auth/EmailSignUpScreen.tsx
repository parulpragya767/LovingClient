 ...
 export default function EmailSignUpScreen() {
   ...
   return (
     <View className="flex-1 bg-[#25292e] px-6 justify-center">
       <Text className="text-3xl font-bold text-center text-white mb-10">Create account</Text>
       ...
       <View className="space-y-4">
         ...
         >
           {loading ? (
             ...
             <Text className="text-[#25292e] font-semibold">Create Account</Text>
           )}
         </TouchableOpacity>
 
         <TouchableOpacity onPress={() => router.replace('/auth/login')} className="mt-4 items-center">
           <Text className="text-white/80">Already have an account? Sign in</Text>
         </TouchableOpacity>
       </View>
     </View>
   );
